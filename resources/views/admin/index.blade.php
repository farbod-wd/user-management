                        ...
                        <div class="d-flex justify-content-around align-items-center flex-wrap mb-4">
                            <div class="user-analytics text-center me-2">
                                ...
                                <div class="d-flex align-items-center mt-2">
                                    ...
                                    <h3 class="mb-0">{{ $userCount }} نفر</h3>
                                </div>
                            </div>
                ...
                <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center me-3">
                            <img src="{{ asset('./panel/assets/img/avatars/4.png') }}" alt="Avatar"
                            ...
                            <div class="d-flex flex-column me-2">
                                ...
                                <ul class="list-unstyled me-2 d-flex align-items-center avatar-group mb-0">
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        ...
                                        <img class="rounded-circle" src="{{ asset('panel/assets/img/avatars/5.png') }}"
                                            alt="Avatar">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        title="پیتر پارکر" class="avatar avatar-xs pull-up">
                                        <img class="rounded-circle" src="{{ asset('panel/assets/img/avatars/12.png') }}"
                                            alt="Avatar">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        title="استیو جابز" class="avatar avatar-xs pull-up">
                                        <img class="rounded-circle" src="{{ asset('panel/assets/img/avatars/6.png') }}"
                                            alt="Avatar">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        title="Ellen Wagner" class="avatar avatar-xs pull-up">
                                        <img class="rounded-circle" src="{{ asset('panel/assets/img/avatars/14.png') }}"
                                            alt="Avatar">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        title="بیل گیتس" class="avatar avatar-xs pull-up">
                                        <img class="rounded-circle" src="{{ asset('panel/assets/img/avatars/10.png') }}"
                                            alt="Avatar">
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="timeline-event pb-2">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        <div class="avatar me-3">
                                            <img src="{{ asset('panel/assets/img/avatars/1.png') }}" alt="Avatar"
